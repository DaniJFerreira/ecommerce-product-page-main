...
export class MenuHandler {
  ...
  this.isToggleActive = event ? event.currentTarget.classList.toggle('is-active') : false;
  ...
  } else if (!isActive && this.isToggleActive) { // We only want to do the following if activating the menu
...
//   toggleOverlay(visible) {
//     this.overlay.classList.toggle('overlay-visible', visible);
//   }

//   toggleVisible(elementsToToggle, toggleHide) {
//     Utils.forEach(elementsToToggle, element => {
//       element.classList.toggle('hidden', toggleHide);
//     });
//   }
